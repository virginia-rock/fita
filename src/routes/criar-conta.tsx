...
import { createDemoAccount, setDemoSession, type DemoPlan } from "@/lib/demo-account";
...
function selectedPlan(): Exclude<DemoPlan, "local"> {
            ...
            <p className="mt-4 text-sm leading-relaxed text-ink/60">
              {requiresEmailConfirmation ? (
                <>
                  ...
                  <strong className="text-ink">{createdEmail}</strong>. Confirme seu e-mail e depois
                  entre na conta para continuar.
                </>
              ) : (
                <>
                  Sua conta foi criada para <strong className="text-ink">{createdEmail}</strong>.
                  Você pode continuar para o checkout.
                </>
              )}
            </p>
            <button
              ...
              onClick={() =>
                window.location.assign(
                  requiresEmailConfirmation ? "/entrar" : `/checkout?plan=${plan}`,
                )
              }
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mt-12 rounded-sm bg-vellum/40 p-6 ring-1 ring-ink/10 md:p-8">
          ...
          <p className="mt-3 text-sm leading-relaxed text-ink/60">
            A conta é necessária para acessar o Fita. Comece no plano gratuito ou continue para um
            plano Pro.
          </p>
          <div className="mt-8">
            <AuthForm
          ...
          <p className="mt-6 text-center text-sm text-ink/55">
            Já tem uma conta?{" "}
            <Link to="/entrar" className="text-clay hover:underline">
              Entrar
            </Link>
            .
          </p>
