...
O hero deve deixar claro que o valor principal do Fita é **acompanhar evolução corporal**, e não simplesmente armazenar dados.

---

## 2. Alterar o pricing para usuários individuais
...
O Pro não deve parecer apenas uma cobrança por armazenamento. Ele deve representar uma experiência mais completa de acompanhamento de evolução.

---

# 4. Criar linha de planos profissionais
...
1. reescrever hero;
2. alterar Free/Pro;
3. adicionar mensal e anual;
4. remover R$ 29,90 da comparação principal;
5. criar seção para profissionais;
6. exibir Personal, Personal Pro e Studio.
...
2. planos;
3. limites de alunos;
4. relacionamento profissional → aluno;
5. controle de assinatura.
...
3. indicadores de evolução;
4. filtros avançados;
5. visão geral dos alunos.
